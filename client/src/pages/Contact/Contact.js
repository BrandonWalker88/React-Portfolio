...
import LinkedInImg from "../../images/linkin.png";
import GHImg from "../../images/Git_hub_logo.jpg";
      ...
      <div className="row">
        ...
        <div className="col-md-2">
          <Link href="https://www.linkedin.com/in/brandon-walker-026b5399">
            <img className="icon" src={LinkedInImg} alt="linked-in" />
          </Link>
        </div>
        <div className="col-md-2">
          <Link href="https://github.com/BrandonWalker88">
            <img className="icon" src={GHImg} alt="Github" />
          </Link>
        </div>
      </div>
    </div>
